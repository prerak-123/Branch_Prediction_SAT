...
class CACHE : public MEMORY {
  public:
    ...
    uint8_t cache_type;
    int offsets[n_offsets] = {1,-1,2,-2,4,-4,8,-8, 16, -16, 32, -32, 64, -64, 3, -3,  5,-5, 9,-9, 6,-6, 15, -15,25,-25, 20, -20, 10, -10, 18, -18, 30, -30, 45, -45};
    int offset = 1;
    int scores[n_offsets];
    int nrounds = 0;
    int ind = 0;
    vector<uint64_t> rr;
    bool prefetchStop = false;
